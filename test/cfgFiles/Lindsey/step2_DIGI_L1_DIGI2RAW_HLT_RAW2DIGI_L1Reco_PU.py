...
# with command line options: step2 --conditions auto:startup -s DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco --pileup_input das:/RelValMinBias/CMSSW_5_2_1-START52_V4-v1/GEN-SIM --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --pileup default -n 1000 --eventcontent FEVTDEBUGHLT --filein file:step1.root --fileout file:step2.root --no_exec

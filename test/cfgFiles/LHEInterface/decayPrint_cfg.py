...
#process.load("Configuration.StandardSequences.VtxSmearedNoSmear_cff")#Changed from original
...
#process.schedule = cms.Schedule(process.printTree)
#process.schedule = cms.Schedule(process.p0, process.p)
#process.p = cms.Path(process.printTree)
process.mypath = cms.Path(process.printDecay)
#process.schedule = cms.Schedule(process.printTree)

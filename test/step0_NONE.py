...
process.source = cms.Source("LHESource",
                            fileNames = cms.untracked.vstring('file:reweighted_events_test.lhe')
    #fileNames = cms.untracked.vstring('file:test_MadGraph_1_5_11.lhe')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reweighted_events_step0.root'),

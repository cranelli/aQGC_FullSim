...
# with command line options: step3 --conditions auto:startup --pileup_input das:/RelValMinBias/CMSSW_5_2_1-START52_V4-v1/GEN-SIM -n 1000 --eventcontent RECOSIM -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --pileup default --filein file:step2.root --fileout file:step3.root --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:reweighted_events_step2.root')
)
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reweighted_events_step3.root'),
